...
const { registerUser, loginUser, logoutUser, updateProfile, changePassword, deactivateOwnAccount,
    getProfile, promoteToCreator, demoteCreator, getAllCreators, getAllUsers } = require('../controllers/authController');
